# -*- coding: utf-8 -*-
"""
Created on Sun May  2 16:17:46 2021
...
wcat = pd.read_csv("C:/Users/PRAVALLIKA/Downloads/Datasets_SLR/calories_consumed.csv",encoding = "utf-8")
wcat.info()

wcat.rename({'Calories Consumed': 'calories', 'Weight gained (grams)': 'weight'}, axis=1, inplace=True)
...
plt.bar(height = wcat.weight, x = np.arange(1, 15, 1))
...
data = {"MODEL":pd.Series(["SLR", "Log model", "Exp model", "Poly model"]), "RMSE":pd.Series([rmse1, rmse2, rmse3])}
