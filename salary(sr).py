# -*- coding: utf-8 -*-
"""
Created on Sun May  2 17:01:56 2021
...
wcat = pd.read_csv("C:/Users/PRAVALLIKA/Downloads/Datasets_SLR/Salary_Data.csv",encoding = "utf-8")
wcat.info()

wcat.rename({'YearsExperience': 'calories', 'Salary': 'weight'}, axis=1, inplace=True)
...
plt.bar(height = wcat.calories, x = np.arange(1, 30, 1))
plt.hist(wcat.calories) #histogram
plt.boxplot(wcat.calories) #boxplot

plt.bar(height = wcat.weight, x = np.arange(1, 30, 1))
