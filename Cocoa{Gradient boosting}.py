...
df = pd.read_csv("C:/data science/pending/Ensemble_Techniques_Problem Statement/Datasets/Cocoa.csv")
...
df = pd.get_dummies(df, columns = ["Beans", "Gener"], drop_first = True)

df.head()


# Input and Output Split
predictors = df.loc[:, df.columns!="Origin"]
type(predictors)
