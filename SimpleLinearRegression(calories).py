...
wcat = pd.read_csv("C:/data science/simple linear/Simple Linear Regression_Problem Statement/calories_consumed.csv")
...
plt.bar(height = wcat.CaloriesConsumed, x = np.arange(1, 15, 1))
plt.hist(wcat.CaloriesConsumed) #histogram
plt.boxplot(wcat.CaloriesConsumed) #boxplot

plt.bar(height = wcat.Weightgained, x = np.arange(1, 15, 1))
plt.hist(wcat.Weightgained) #histogram
plt.boxplot(wcat.Weightgained) #boxplot
